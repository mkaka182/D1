...
class GitUtils(object):
    ...
    def commit(self, branch: str = 'master', message: str = 'Auto commit'):
        ...
        if has_changed is True:
            ...
            self.repo.git.push('main', branch)
    
    
if __name__ == '__main__':
    mygit = GitUtils(
        repo='git@github.com:mkaka182/demo.git',
        user={
            'ssh': '/usr/local/bin/my_gitpython_ssh',
            'name': 'mkaka182',
            'email': 'mkaka5942@gmail.com',
        }
	#path = '/home/mkaka5942/project'
       
    )
    
    with open('/home/mkaka5942/repo1/test.txt', 'w+') as f:
